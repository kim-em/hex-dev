...
The companion and proof-probe targets build locally. The release-quality
paired kernel sweep, benchmark report, comparator plots, and external native
comparator adapters remain to be recorded.

## Next step

Record the paired kernel sweep on a clean commit, apply the predeclared
two-family/2× representation threshold, then finish the native comparator
evidence and Phase 4 report.
