...
powers and closed division/inversion. Direct
...
from its power equation. These conversion theorems do not perform source
alias discovery. `Specialize.polynomial` substitutes canonical algebraic
