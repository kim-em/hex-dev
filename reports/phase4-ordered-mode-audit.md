...
| HexNumberFieldTower | Negation now has passing dense linear evidence. Dense `toPrimitive` rejects its preregistered quadratic wall model because primitive-coordinate height is not bounded, while recursive inversion and division remain mode 4. Their cheap fixed anchors are not performance evidence. | [#9665](https://github.com/kim-em/hex-dev/issues/9665), [#9815](https://github.com/kim-em/hex-dev/issues/9815), [#9944](https://github.com/kim-em/hex-dev/issues/9944), [#9945](https://github.com/kim-em/hex-dev/issues/9945) |
