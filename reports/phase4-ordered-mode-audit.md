...
| HexNumberFieldTower | The dense `toPrimitive` family rejects its preregistered quadratic wall model because the flattening's primitive-coordinate height is not bounded; negation, recursive inversion, and division also remain mode 4. Their cheap fixed anchors are not performance evidence. | [#9665](https://github.com/kim-em/hex-dev/issues/9665), [#9815](https://github.com/kim-em/hex-dev/issues/9815), [#9945](https://github.com/kim-em/hex-dev/issues/9945) |
