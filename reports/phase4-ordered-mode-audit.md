...
| HexNumberFieldTower | Full-basis `toPrimitive` is repaired and passes its original cubic model, but negation, recursive inversion, and division remain mode 4 after checked parametric failures; their cheap fixed anchors are not performance evidence. | [#9665](https://github.com/kim-em/hex-dev/issues/9665), [#9815](https://github.com/kim-em/hex-dev/issues/9815) |
