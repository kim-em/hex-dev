...
| HexNumberFieldTower | The `toPrimitive` zero-coordinate defect is repaired, but its sparse unit-basis diagnostic does not cover the dense public bound; negation, recursive inversion, and division also remain mode 4. Their cheap fixed anchors are not performance evidence. | [#9665](https://github.com/kim-em/hex-dev/issues/9665), [#9815](https://github.com/kim-em/hex-dev/issues/9815) |
