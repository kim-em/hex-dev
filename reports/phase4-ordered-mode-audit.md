...
| HexNumberFieldTower | Resolved: seven advertised surfaces have derived passing mode-1 models; ten surfaces have canonical zero-grace mode-3 budgets after recorded parameterization attempts; branch, hash, protocol, and comparator anchors are explicitly excluded from performance coverage. | [#9665](https://github.com/kim-em/hex-dev/issues/9665), [#9815](https://github.com/kim-em/hex-dev/issues/9815) |
