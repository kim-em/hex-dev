...
and records clean preregistration commit `5f4bab2fc`. For the original CPU 19
protocol, a three-second `/proc/stat` postflight sample measured 1.33% busy on
each sibling; load averages were 1.28, 2.53, and 2.87 on a 96-logical-CPU host.
This is a postflight protocol check, not a claim that the host was idle
throughout.
...
from clean commit `6a4911dbb` after its quadratic model failed. The
...
| [dense forward-map export](bench-results/hex-number-field-tower-dense-to-primitive-5f4bab2f-chungus2-cpu1.json) | clean preregistration commit `5f4bab2fc`; five trials at every `n = 2, 3, 4, 5, 6, 9` rung | CPU 1 | `4e6bdf834eb2e98ead56ac84f46da08eacd78c51ecd60ecf947af67b66df36f0` |
| [dense forward-map profile](bench-results/hex-number-field-tower-dense-to-primitive-profile-6a4911db-chungus2.json) | clean `6a4911dbb`; timed-region-filtered dimension-18 dense public map | unpinned shape capture | `5dadec1dfefc811addb7e7ae242f88d81ab3880f91a19570356e4e92402cd7f9` |
