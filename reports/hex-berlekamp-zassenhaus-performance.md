...
|---|---|---|---|
| `runFactorChecksum` | proposal replay | proposal 57%, prime walk 40% | not executed |
| `runFactorFallbackProbeChecksum` | proposal replay | proposal 57%, prime walk 40% | not executed |
| `runFactorCompareChecksum` | classical | Hensel 46%, prime walk 27%, recombination 15% | not executed |
| `runFactorDegreeHeightChecksum` | classical | Hensel 52%, prime walk 26%, recombination 12% | not executed |
| `runFastPathPrecisionLocalChecksum` | setup only | Hensel 76%, precision cap 23% | not executed |

The clean inclusive export is
`reports/bench-results/hexbz-complexity-audit-e51066e1-chungus2.json`
(SHA-256 `ca5d00c27704118d03f3a60c6e0b976ba2fe14c79f26b23d0059aa070a0b21a7`),
...
different calls. No phase covered by the cited lattice analysis controls any
measured family.
...
records all fourteen mode-3 registrations passing their four-second budgets,
with all five repeats successful and every expected hash matching. The
