...
|---|---|---|---|
| `runFactorChecksum` | proposal replay | proposal 55%, prime walk 40% | not executed |
| `runFactorFallbackProbeChecksum` | proposal replay | proposal 55%, prime walk 40% | not executed |
| `runFactorCompareChecksum` | classical | Hensel 45%, prime walk 27%, recombination 15% | not executed |
...
`reports/bench-results/hexbz-complexity-audit-a11f9e7b-chungus2.json`
(SHA-256 `759cd2b89d97846142796bad2babd733f38a10464d37d75991dcedbed2ea305f`),
