...
The current local `hexnumberfield_bench verify` invocation completes in 10.56 s
...
verification wall time is consistent with current code. The larger medians in
