# Historical 38-entry HexConway performance report

This snapshot describes the previous 38-entry implementation and its earlier
budget policy. See [the current report](hex-conway-performance.md) for expanded
coverage and complete-library rebuild measurements.
