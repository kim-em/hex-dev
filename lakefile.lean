...
lean_exe hexinterval_emit_constants where
  srcDir := "conformance"
  root := `HexInterval.EmitConstants
...
lean_exe hexinterval_constants_bench where
  srcDir := "bench"
  root := `HexInterval.ConstantsBench
