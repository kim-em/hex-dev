...
lean_lib HexRCFRealCoefficients where
  ...
  globs := #[`HexRCF.RealCoefficients, `HexRCF.RealCoefficients.Reify,
    ...
    `HexRCF.RealCoefficients.Carrier, `HexRCF.RealCoefficients.Field,
