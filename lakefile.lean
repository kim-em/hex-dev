...
lean_lib HexIntervalExperiment where
  globs := #[`HexInterval.Experiment.Representation,
    ...
    `HexInterval.Experiment.PayloadArena, `HexInterval.Experiment.PayloadSession,
    `HexInterval.Experiment.PolicySession, `HexInterval.Experiment.SemanticReplay]
