...
The exact eight numerical leaves in the pinned PNT+ proofs are authenticated
...
#guard sourceRows[7]? == some ⟨7, 22, 1, 117352333, .lowerLe, 64, 12⟩
...
theorem exp29Upper : Real.exp 29 ≤ (4000000000000000000 : Real) := by
  simpa [certificates, sourceRows, Holds] using
    certificateHolds sourceRows[0] (by set_option maxRecDepth 100000 in decide)

theorem exp10Upper : Real.exp 10 < (4000000000000000000 : Real) := by
  simpa [certificates, sourceRows, Holds] using
...
theorem exp43Lower : (4000000000000000000 : Real) ≤ Real.exp 43 := by
  simpa [certificates, sourceRows, Holds] using
    certificateHolds sourceRows[6] (by set_option maxRecDepth 100000 in decide)

theorem exp22Lower : (117352333 : Real) ≤ Real.exp 22 := by
  simpa [certificates, sourceRows, Holds] using
    certificateHolds sourceRows[7] (by set_option maxRecDepth 100000 in decide)
