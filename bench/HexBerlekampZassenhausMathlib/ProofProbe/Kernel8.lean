...
/-! `irreducibility!` on the Swinnerton-Dyer octic
`X⁸ − 40X⁶ + 352X⁴ − 960X² + 576` (minimal polynomial of `√2 + √3 + √5`):
the degree-8 rung of the kernel-fallback ladder, twice the degree of
`Kernel4` with the same decline shape. -/

set_option maxHeartbeats 8000000 in
theorem kernel8 :
    Irreducible
      (X ^ 8 - 40 * X ^ 6 + 352 * X ^ 4 - 960 * X ^ 2 + 576 : Polynomial ℤ) :=
  irreducibility!
    (X ^ 8 - 40 * X ^ 6 + 352 * X ^ 4 - 960 * X ^ 2 + 576 : Polynomial ℤ)

#print axioms kernel8
