...
/-- Every matrix row belongs to the submodule generated by all rows. -/
...
/-- Every row before `t` belongs to the submodule generated by that row prefix. -/
...
/-- The submodule generated by a row prefix lies in the full row lattice. -/
...
/-- A row combination supported before `t` belongs to the corresponding prefix submodule. -/
...
proof method converts that hypothesis back through `mem_latticeSubmodule_iff`,
