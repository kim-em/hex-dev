...
- **[hex-matrix-tactic](../../HexMatrixTactic/SPEC/hex-matrix-tactic.md)**: proof-producing `det`, `rank`, and `char_poly` frontends, numeric entry models and certificate strategy
...
- **[hex-matrix-tactic-mathlib](../../HexMatrixTacticMathlib/SPEC/hex-matrix-tactic-mathlib.md)**: Mathlib matrix literals, result transport and opt-in `norm_det` / `norm_rank` adapters
