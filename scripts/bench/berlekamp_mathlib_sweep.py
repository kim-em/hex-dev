...
BASELINE = ProbeModule("HexBerlekampMathlib.ProofProbe.Baseline")
FACTOR8 = ProbeModule(
    "HexBerlekampMathlib.ProofProbe.Factor8", EXPECTED_AXIOMS
)
IRREDUCIBLE16 = ProbeModule(
    "HexBerlekampMathlib.ProofProbe.Irreducible16", EXPECTED_AXIOMS
)
...
SPEC = SweepSpec(
    ...
    probe_target="HexBerlekampMathlibProofProbe",
    ...
    extra_sources=(
        ...
        Path("HexBerlekampMathlib/SPEC/hex-berlekamp-mathlib.md"),
    ),
    output_stem="hex-berlekamp-mathlib",
    required_samples=6,
)
