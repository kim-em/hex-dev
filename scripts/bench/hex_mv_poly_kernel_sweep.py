...
SPEC = SweepSpec(
    ...
    pairs=(
        ...
        comparison(
            "cancellation-inputs-8",
            "HexCancellationInputs8",
            "SortedCancellationInputs8",
        ...
        comparison(
            ...
            comparator="lex",
            support="two-axis cancellation",
            workload_control="cancellation-inputs-8",
            ratio_threshold=2.0,
        ),
        comparison(
            "sos-3",
    ...
    schema="hex-mv-poly-kernel-proof-probes-v4",
    measurement=(
        "paired-fresh-module-olean-wall-import-construction-"
        "subtracted-ratio-bounded-v4"
    ),
