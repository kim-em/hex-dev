#!/usr/bin/env python3
"""Capture operation-only real-formula profiles with perf and the samply filter.
...
CASES = {
    'syntax': ('decode', 32768, 3_000_000_000),
    'monomials': ('decodeTerms', 8192, 1_000_000_000),
    'arity': ('evalArity', 2048, 1_000_000_000),
    'coefficient-bits': ('evalBits', 2097152, 1_000_000_000),
    'exponents': ('evalExponent', 281474976710656, 1_000_000_000),
}
...
def main():
    ...
    exe = ROOT / '.lake/build/bin/hexrealformula_bench'
    record = dict(family=args.family, function='Hex.RealFormula.Bench.' + name,
