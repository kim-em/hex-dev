...
#
# The script does NOT install Isabelle itself. CI installs Isabelle
# from the upstream tarball before invoking this script (see
# `.github/workflows/ci.yml`); locally, the user is responsible for
# putting `isabelle` on `PATH`.
#
